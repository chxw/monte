...
class Asset():
	...
	def fetch_company(self):
		...
		data = requests.get("https://cloud.iexapis.com/stable/stock/"+query+"/company?token="+token).json()
	...
	def fetch_financials(self):
		query = urllib.parse.quote(self.ticker)
		data = requests.get("https://cloud.iexapis.com/stable/stock/"+query+"/cash-flow?token="+token).json()
	...
	def fetch_tops(self):
		query = urllib.parse.quote(self.ticker)
		data = requests.get("https://cloud.iexapis.com/stable/tops/?token="+token).json()
